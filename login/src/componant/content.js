            ...
            <div className='container-fluid' id="content">
                {
                    this.state.data.map((data, index) => {
                        return <div className="d-flex flex-column justify-content-between p-3 m-3 bg-dark text-light shadow" key={index} >
                            <div className='col-12 text-break' onClick={() => this.show(data.id)} style={{cursor:"pointer"}} >
                                <h1 className='text-primary' >{data.title}</h1>
                                
                            </div>
                            <div className='d-flex flex-row align-items-center justify-content-between text-light contentDescH' >
                                <p className={`contentDescH col-11`} id={"descriptionC" + data.id}>{data.description}</p>
                                
                                <div className='d-flex flex-column align-items-center justify-content-center text-break col-1'>
